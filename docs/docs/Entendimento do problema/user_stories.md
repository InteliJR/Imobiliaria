...
<div align="center">
  <p> <b>Tabela de User Stories </b> - User Story 1</p>
    ...
    | Testes de aceitação    | Critério de aceitação: CR-01 a. O administrador seleciona determinado imóvel para visualizar suas informações. <br /> – Os dados do contrato de locação do imóvel são visualizados = correto. <br /> – Os dados do contrato de locação do imóvel não são visualizados = errado, deve ser corrigido. |
...
<div align="center">
  ...
  | Critérios de aceitação| CR-01 - O sistema deve permitir a emissão de boletos de aluguel. <br /> Validação-01: Os boletos são gerados com todas as informações necessárias (valor, data de vencimento, etc.). <br /> Validação-02: Os boletos são enviados automaticamente para o e-mail dos locatários. |
  | Testes de aceitação   | Critério de aceitação: <br /> CR-01 a. O administrador emite um boleto. <br /> – O boleto é gerado com todas as informações corretas = correto. <br /> – O boleto não contém todas as informações corretas = errado, deve ser corrigido. <br /> b. O administrador envia o boleto para o locatário. <br /> – O locatário recebe o boleto por e-mail = correto. <br /> – O locatário não recebe o boleto por e-mail = errado, deve ser corrigido. |
...
<div align="center">
  ...
  | Critérios de aceitação| CR-01 - O sistema deve enviar notificações por e-mail para os locatários sobre qualquer alteração no contrato. <br />Validação-01: As notificações contêm informações detalhadas sobre a alteração. <br /> Validação-02: As notificações são enviadas imediatamente após a alteração. |
  | Testes de aceitação   | Critério de aceitação: CR-01 a. O administrador altera um contrato. <br /> – O locatário recebe uma notificação detalhada por e-mail = correto. <br /> – O locatário não recebe a notificação = errado, deve ser corrigido. |
