...
export default function FeaturesSection() {
  return (
    <div
      className="w-full h-14 flex justify-center mt-4 z-10 bg-no-repeat bg-cover overflow-hidden"
      style={{
        backgroundImage: `url(${houseBg})`,
        backgroundPosition: "center calc(100% + 40px)",
        borderRadius: "0.25rem", // Adição de arredondamento direto por aqui porque por tailwind não estava sendo aplicado.
